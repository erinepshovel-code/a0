    ...
    "provider::openai": {
        ...
        "route_config": {
            ...
            "presets": {
                ...
                "coding":     {"conduct": "gpt-4o",      "perform": "gpt-4o",      "practice": "codex-mini-latest", "record": "gpt-4o-mini", "derive": "o1"},
            },
    ...
    "provider::grok": {
        ...
        "route_config": {
            ...
            "presets": {
                ...
                "coding":     {"conduct": "grok-4-1-fast-reasoning",     "perform": "grok-4-1-fast-reasoning",     "practice": "grok-4-1-fast-reasoning",     "record": "grok-4-1-fast-non-reasoning", "derive": "grok-4.20-0309-reasoning"},
            },
    ...
    "provider::gemini": {
        ...
        "route_config": {
            ...
            "presets": {
                ...
                "coding":     {"conduct": "gemini-2.5-flash",     "perform": "gemini-2.5-flash",     "practice": "gemini-2.5-pro",        "record": "gemini-2.0-flash-lite", "derive": "gemini-2.5-pro"},
            },
    ...
    "provider::claude": {
        ...
        "route_config": {
            ...
            "presets": {
                ...
                "coding":     {"conduct": "claude-3-5-sonnet-20241022", "perform": "claude-3-5-sonnet-20241022", "practice": "claude-3-5-sonnet-20241022", "record": "claude-3-5-haiku-20241022",  "derive": "claude-3-opus-20240229"},
            },
